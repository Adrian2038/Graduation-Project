...
- (void)showNoNetworkAlert
{
	UIAlertView *alertView = [[UIAlertView alloc] 
                              initWithTitle:NSLocalizedString(@"没有可用的蓝牙或者WIFI", @"No network alert title")
                              message:NSLocalizedString(@"请打开您设备上的蓝牙或者WIFI以参加游戏.", @"No network alert message")
                              delegate:nil
                              cancelButtonTitle:NSLocalizedString(@"确认", @"Button: OK")
...
{
	UIAlertView *alertView = [[UIAlertView alloc] 
                              initWithTitle:NSLocalizedString(@"游戏连接失败", @"Client disconnected alert title")
                              message:NSLocalizedString(@"您未成功连接游戏，请再试一次.", @"Client disconnected alert message")
                              delegate:nil
                              cancelButtonTitle:NSLocalizedString(@"确认", @"Button: OK")
                              otherButtonTitles:nil];
